...
for (up in c(1:20)*500){
  ...
  corlist[[paste0('up', as.character(up+500), 'up', as.character(up))]] <- corvec2
}


pdf('/home-4/whou10@jhu.edu/scratch/Wenpin/spatial/Hampem_Nature_2017/zonatedtrain/check/correlation_between_training_expr_DNAm_while_DNAm_calculate_on_upstream500bpbin.pdf', width = 10, height = 7)
par(mfrow=c(4,5))
